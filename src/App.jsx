    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Santa Express - MOVED AND RESTYLED */}
          <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden group">
            <div className="relative aspect-video bg-gray-200">
              <iframe
            ...
            <div className="p-4">
              <h4 className="text-xl font-bold text-gray-800 mb-2">Marty Holtman's Santa Express</h4>
              <p className="text-sm text-blue-600 mb-2">An Emmy-winning holiday classic</p>
              <p className="text-gray-600 text-sm mb-3">
                Follow along in an adventure to the North Pole as our beloved Marty Holtman goes on a journey
                to deliver letters for Santa from the children of Idaho.
              </p>
              <p className="text-xs text-gray-500 italic">Duration: 7:24</p>
            </div>
          </div>
