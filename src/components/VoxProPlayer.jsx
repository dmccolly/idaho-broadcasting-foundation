...
const detectMediaType = (url) => {
  ...
  if (['mp4', 'webm', 'ogg', 'mov', 'avi'].includes(extension)) {
    ...
    setMediaType('image');
    setIsLoading(false); // Images load immediately
...
const VoxProPlayer = () => {
  ...
  return (
    <div className="h-full bg-gray-900 text-white flex flex-col">
        <div className="flex-grow p-4 md:p-6 flex flex-col items-center">
            {/* Compact Main Control Panel */}
            <div className="w-full max-w-xl bg-gray-800 rounded-lg p-4 md:p-6 shadow-2xl border border-gray-600 mb-6">
              {/* Compact VoxPro Header */}
              <div className="text-center mb-4">
                <h3 className="text-xl md:text-2xl font-bold text-green-400 mb-1">VoxPro Media Player</h3>
            ...
            <div className="w-full max-w-4xl bg-gray-800 rounded-lg p-4 flex-grow overflow-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {assignments.map((assignment) => (
                  <div key={assignment.id} className="bg-gray-700 rounded p-3 border border-gray-600">
                    ...
                    <h4 className="text-white font-medium mb-1 text-sm truncate">{assignment.title}</h4>
