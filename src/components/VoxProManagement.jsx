...
// Enhanced Universal Media Player Component - FIXED AUDIO ECHO
const UniversalMediaPlayer = ({ assignment, onClose, onMinimize, isMinimized, windowId }) => {
  ...
  const initializeWavesurfer = async () => {
    ...
    try {
      ...
      // Disconnect audio output from Wavesurfer
      if (ws.backend && ws.backend.disconnectSource) {
        try {
          ws.backend.disconnectSource();
        } catch (e) {
          console.log('Wavesurfer audio already disconnected');
        }
      }

      console.log('✅ Wavesurfer ready for VISUALIZATION ONLY (muted)');

    } catch (error) {
      console.warn('⚠️ Wavesurfer visualization error (using fallback):', error);
        ...
        return (
          <div className="bg-gray-800 rounded p-4">
            ...
            <audio
              ...
              onTimeUpdate={(e) => {
                ...
                if (wavesurferRef.current && duration > 0) {
                  const progress = e.target.currentTime / duration;
                  try {
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Don't change Wavesurfer volume - it's muted
                  }}
                  className="w-16"
                />
            ...
            <div className="mt-3 text-xs text-gray-400 space-y-1">
              ...
              <div>📊 Visualization: Wavesurfer (Muted)</div>
...
export default VoxProManagement;import { useState, useEffect, useRef } from 'react';
import { supabase } from '../lib/supabase';
import WaveSurfer from 'wavesurfer.js';
