...
const VoxProManagement = () => {
  ...
  // File input ref for direct access - THIS IS THE KEY FIX
  ...
  // Trigger file input dialog - THIS IS THE KEY FIX
  ...
  const clearForm = () => {
    ...
    // Clear file input - FIXED VERSION
    if (fileInputRef.current) {
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div 
                  className="border-2 border-dashed border-gray-600 rounded p-4 text-center hover:border-green-400 transition-colors cursor-pointer"
